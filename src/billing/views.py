...
from billing.models import SubscriptionPrice, UserSubscription
from billing import utils as subs_utils
...
def user_subscription_view(request,):
    ...
    return render(request, 'billing/user_detail_view.html', {"subscription": user_sub_obj})
...
def user_subscription_cancel_view(request,):
    ...
    if request.method == "POST":
        ...
        return redirect(user_sub_obj.get_absolute_url())
    return render(request, 'billing/user_cancel_view.html', {"subscription": user_sub_obj})
